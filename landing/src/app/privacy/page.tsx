...
export const metadata: Metadata = {
  ...
  description: 'How Piyrox collects, uses, shares, and protects your personal data, plus your privacy rights and cookie practices.',
  alternates: { canonical: 'https://piyrox.shop/privacy' },
  openGraph: {
    title: 'Privacy Policy | Piyrox',
    description: 'How Piyrox protects your data and your privacy rights.',
    url: 'https://piyrox.shop/privacy',
    siteName: 'Piyrox',
    type: 'website',
    images: [{ url: '/og.png', width: 1200, height: 630, alt: 'Piyrox Privacy' }],
  },
};

const sections = [
  { title: '1. Introduction', content: `Piyrox ("we", "our", or "us") is committed to protecting your personal information. This Privacy Policy explains what data we collect, how we use it, and your rights regarding that data. By using the Piyrox platform, you consent to the practices described in this policy.` },
      ...
      <main className="min-h-screen bg-background pt-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-10">
          ...
          <div className="border-t border-border pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <p>Questions? <a href="mailto:privacy@piyrox.shop" className="text-brand-light hover:underline">privacy@piyrox.shop</a></p>
