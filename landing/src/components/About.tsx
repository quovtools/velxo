...
const VALUES = [
  { icon: <ShieldCheck className="w-5 h-5 text-[#8B5CF6]" />, title: 'Trust First', desc: 'Every decision we make puts trader safety above everything else.' },
  ...
  { icon: <Globe className="w-5 h-5 text-[#06B6D4]" />, title: 'Africa-Focused', desc: 'Local payments, regional games, and African currencies — no workarounds needed.' },
  { icon: <Users className="w-5 h-5 text-emerald-400" />, title: 'Community Driven', desc: 'Built by gamers, for gamers. The platform evolves with our community.' },
];
      ...
      <div className="bg-[#111827] border border-[#1F2937] rounded-3xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div className="p-10 lg:p-14 space-y-6 border-b lg:border-b-0 lg:border-r border-[#1F2937]">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a href="https://market.velxo.shop/about"
                className="text-center px-6 py-3 bg-[#8B5CF6] hover:bg-[#6D28D9] text-white font-bold rounded-xl text-sm transition">
                Read Full Story
              </a>
              <a href="https://market.velxo.shop/careers"
                className="text-center px-6 py-3 border border-[#1F2937] hover:border-[#8B5CF6]/40 text-gray-300 hover:text-white font-semibold rounded-xl text-sm transition">
                Join the Team
              </a>
            </div>
          </div>
          ...
          <div className="p-10 lg:p-14 space-y-6">
            ...
            {/* Founder card */}
            <div className="mt-6 bg-[#0b0f19] border border-[#1F2937] rounded-2xl p-5 flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#8B5CF6] to-[#06B6D4] flex items-center justify-center text-white font-black text-xl flex-shrink-0">
                BP
              </div>
              <div>
                <p className="font-black text-white">Badeji Precious</p>
                <p className="text-xs text-[#A78BFA] font-semibold">Founder & CEO, Velxo</p>
