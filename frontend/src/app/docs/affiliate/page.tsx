  ...
  return (
    <DocShell>
      <DocHeader
        ...
        description="Love Piyrox? Share it and earn. Our affiliate program pays you a commission when people you refer trade on the platform."
      />
      ...
      <DocSection title="Program benefits">
        <FeatureGrid
          items={[
            ...
            { icon: <Wallet className="w-5 h-5" />, title: 'Wallet payouts', body: 'Commissions land in your piyrox wallet and withdraw like sales.' },
          ]}
        />
      </DocSection>
      ...
      <DocSection title="Rules & best practices">
        <p>
          Promote Piyrox honestly. Don&apos;t spam, use misleading claims, or create fake accounts to
      ...
      <RelatedLinks links={[{ label: 'PiyroxCoins & Rewards', href: '/docs/rewards' }, { label: 'Payments & Wallets', href: '/docs/payments' }, { label: 'Affiliate Page', href: '/affiliate' }]} />
    </DocShell>
  );
}
