...
export declare class GigsController {
    ...
    getPublicGigs(gameName?: string, accountType?: string, search?: string): Promise<ApiResponseDto<({
        seller: {
            user: {
                firstName: string;
                lastName: string;
    ...
    getGig(id: string): Promise<ApiResponseDto<{
        seller: {
            user: {
                firstName: string;
                lastName: string;
    ...
    getMyGigs(userId: string): Promise<ApiResponseDto<{
        id: string;
        status: import(".prisma/client").$Enums.GigStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    createGig(userId: string, dto: CreateGigDto): Promise<ApiResponseDto<{
        id: string;
        status: import(".prisma/client").$Enums.GigStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    updateGig(id: string, userId: string, dto: UpdateGigDto): Promise<ApiResponseDto<{
        id: string;
        status: import(".prisma/client").$Enums.GigStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    deleteGig(id: string, userId: string): Promise<ApiResponseDto<any>>;
    getAllAdmin(status?: string, gameName?: string): Promise<ApiResponseDto<({
        seller: {
            user: {
                email: string;
                firstName: string;
    ...
    reviewGig(id: string, dto: AdminReviewGigDto): Promise<ApiResponseDto<{
        id: string;
        status: import(".prisma/client").$Enums.GigStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    adminDelete(id: string): Promise<ApiResponseDto<any>>;
    purchase(id: string, buyerId: string, quantity?: number, buyerNote?: string): Promise<ApiResponseDto<{
        orderItems: {
            id: string;
            createdAt: Date;
            orderId: string;
